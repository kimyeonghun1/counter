...
<html>
<head>
<meta charset="EUC-KR"> <%-- 여기 CHARSET부분 주의해서 복붙해주시면 됩니다. 옙 그리고! 질문 2개 더 있습니다! --%>
                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <div class="navigation pull-right" id="navigation">
                            <ul>
                                ...
                                <li><a href="classes-list.html" title="Classes" class="animsition-link">목표</a>
                                    <ul>
                                ...
                                <li><a href="testimonial.html" title="Features" class="animsition-link">그래프</a>
                                    <ul>
                                        <li><a href="Graph2.html" title="Testimonial" class="animsition-link">일별그래프</a></li>
                                    </ul>
                                </li>
                                <li><a href="contact.html" title="Contact Us" class="animsition-link">출석</a>
                                    <ul>
