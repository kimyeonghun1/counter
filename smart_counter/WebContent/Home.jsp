...
<!DOCTYPE html>
	<html style="font-size: 16px;">
		<head>
			...
			<script type="application/ld+json">{
				...
				<body class="u-body">
				<header class="u-clearfix u-header u-header" id="sec-aefd">
			...
			<a href="Home.jsp" class="u-image u-logo u-image-1"> <img
				src="./images/smart_logo.png" class="u-logo-image u-logo-image-1">
			</a>
			<nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
				...
				<div class="u-custom-menu u-nav-container">
					<ul class="u-nav u-unstyled u-nav-1">
						...
						<li class="u-nav-item"><a href="signin.html"
							class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" style="padding: 10px 66px;">Login</a></li>
							
						<li class="u-nav-item"><a href="join.html"
							class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" style="padding: 10px 66px;">Join</a></li>
						<%
							} else {
						%>
						...
						<div class="u-inner-container-layout u-sidenav-overflow">
							...
							<ul
								...
								<li class="u-nav-item"><a class="u-button-style u-nav-link"
									href="Home.html" style="padding: 10px 66px;">Home</a></li>
								<li class="u-nav-item"><a class="u-button-style u-nav-link"
									href="About.html" style="padding: 10px 66px;">About</a></li>
								<li class="u-nav-item"><a class="u-button-style u-nav-link"
									href="Contact.html" style="padding: 10px 66px;">Contact</a> <%
 								if (vo == null) {
 								%></li>
								<li class="u-nav-item"><a href="Login.html"
									class="u-button-style u-nav-link" style="padding: 10px 66px;">Login</a></li>
								<li class="u-nav-item"><a href="join.html"
									class="u-button-style u-nav-link" style="padding: 10px 66px;">Join</a></li>
								<%
									} else {
								%>
	...
	<section class="u-align-right u-clearfix u-image u-section-1"
		id="carousel_0b7b">
		<div class="u-clearfix u-sheet u-sheet-1">
					...
					<div
						...
						<div
							...
							<span class="u-icon u-icon-circle u-icon-3"> <svg
									...
									<use xmlns:xlink="http://www.w3.org/1999/xlink"
										xlink:href="#svg-158f"></use></svg>
								<svg class="u-svg-content" viewBox="0 0 60 60" x="0px" y="0px"
									id="svg-158f" style="enable-background: new 0 0 60 60;">
									<g>
									<path
										d="M31.634,37.989c1.041-0.081,1.99-0.612,2.606-1.459l9.363-12.944c0.287-0.397,0.244-0.945-0.104-1.293
		...
		C29.928,35.219,29.762,34.771,29.798,34.315z"></path>
									<path
										d="M54.034,19.564c-0.01-0.021-0.01-0.043-0.021-0.064c-0.012-0.02-0.031-0.031-0.044-0.05
		...
		C30.68,6.002,30.655,6,30.63,6c-0.164,0-0.328,0.011-0.492,0.014C30.022,6.017,29.913,6.016,29.793,6.021z"></path>
									<path
										d="M21.793,14h-5c-0.553,0-1,0.447-1,1s0.447,1,1,1h5c0.553,0,1-0.447,1-1S22.346,14,21.793,14z"></path>
									<path
										d="M21.793,21h-10c-0.553,0-1,0.447-1,1s0.447,1,1,1h10c0.553,0,1-0.447,1-1S22.346,21,21.793,21z"></path>
									<path
										d="M21.793,28h-15c-0.553,0-1,0.447-1,1s0.447,1,1,1h15c0.553,0,1-0.447,1-1S22.346,28,21.793,28z"></path>
									<path
										d="M21.793,35h-19c-0.553,0-1,0.447-1,1s0.447,1,1,1h19c0.553,0,1-0.447,1-1S22.346,35,21.793,35z"></path>
									<path
										d="M21.793,42h-13c-0.553,0-1,0.447-1,1s0.447,1,1,1h13c0.553,0,1-0.447,1-1S22.346,42,21.793,42z"></path>
									<path
										d="M21.793,49h-7c-0.553,0-1,0.447-1,1s0.447,1,1,1h7c0.553,0,1-0.447,1-1S22.346,49,21.793,49z"></path>
						</g></svg></span>
						</div>
					</div>
					<div
						...
						<div
							...
							<span class="u-icon u-icon-circle u-icon-4"><svg
									...
									<use xmlns:xlink="http://www.w3.org/1999/xlink"
										xlink:href="#svg-f32a"></use></svg>
								<svg class="u-svg-content" viewBox="0 0 55.867 55.867" x="0px"
									y="0px" id="svg-f32a"
